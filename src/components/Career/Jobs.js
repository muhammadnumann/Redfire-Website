  ...
  return (
    <div className="max-w-[1140px] mr-auto ml-auto py-20 max-lg:py-10">
      <div className=" mx-5 flex items-center">
        <div className=" relative border-[2px] w-fit border-[#B3B3B3] hover:border-[#000] rounded-lg px-3 ">
          <input
            name="subject"
            type="text"
            value={searchQuery}
        ...
        <select
          ...
          className="flex items-center mx-5 border-[#B3B3B3] border-[2px] rounded-lg p-3 bg-white  focus:outline-none  focus:border-[#B3B3B3]"
        >
